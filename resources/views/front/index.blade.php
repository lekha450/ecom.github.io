                        ...
                        <li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                              ...
                              <span class="aa-product-price">Rs {{$home_products_attr[$productArr->id][0]->price}}</span>
                              <span class="aa-product-price"><del>{{$home_products_attr[$productArr->id][0]->mrp}}</del></span>
                            </figcaption>
                          </figure>                        
      ...
      <div class="row">
        <div class="col-md-12">        
          <div class="row">
            ...
            <a href="#"><img src="{{url('front_assets/img/fashion-banner.jpg')}}" alt="fashion banner img"></a>
          </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="aa-popular-category-area">
              <!-- start prduct navigation -->
             <ul class="nav nav-tabs aa-products-tab">
                <li class="active"><a href="#popular" data-toggle="tab">Tranding</a></li>
                <li><a href="#featured" data-toggle="tab">Featured</a></li>
                <li><a href="#latest" data-toggle="tab">Discounted</a></li>                    
              </ul>
              <!-- Tab panes -->
              <div class="tab-content">
                        ...
                        <li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                              ...
                              <span class="aa-product-price"><del>{{$home_tranding_product_attr[$productArr->id][0]->mrp}}</del></span>
                            </figcaption>
                          </figure>                        
                        ...
                        <li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                              ...
                              <span class="aa-product-price"><del>{{$home_featured_product_attr[$productArr->id][0]->mrp}}</del></span>
                            </figcaption>
                          </figure>                        
                        ...
                        <li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                              ...
                              <span class="aa-product-price"><del>{{$home_discounted_product_attr[$productArr->id][0]->mrp}}</del></span>
                            </figcaption>
                          </figure>                        

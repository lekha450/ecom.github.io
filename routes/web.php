...
Route::group(['middleware' => 'Admin_auth'], function () {
    ...
    Route::post('admin/manage_category_process', [CategoryController::class, 'manage_category_process'])->name('categroy.manage_category_process');
    ...
    Route::get('admin/color/status/{status}/{id}', [ColorController::class, 'status']);
     ...
     Route::post('admin/manage_product_process', [ProductController::class, 'manage_product_process'])->name('product.manage_product_process');
     ...
     Route::post('admin/manage_brand_process', [BrandController::class, 'manage_brand_process'])->name('brand.manage_brand_process');
    ...
    Route::post('admin/manage_tax_process', [TaxController::class, 'manage_tax_process'])->name('tax.manage_tax_process');
    ...
    Route::get('admin/tax/status/{status}/{id}', [TaxController::class, 'status']);
      ...
      Route::post('admin/manage_home_banner_process', [HomeBannerController::class, 'manage_home_banner_process'])->name('home_banner.manage_home_banner_process');
